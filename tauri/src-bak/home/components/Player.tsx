...
export function Player() {
  ...
  // TODO: This was AI generated, and I do not like it. Figure out a better way to do this
  useEffect(() => {
    ...
    const unlistenState = events.updatedPauseState.listen((event) => {
      setIsPlaying(!event.payload);
    });

    const unlistenPosition = events.updatedTrackProgress.listen((event) => {
